  			...
  			<table style="background-color: blue">
		      	<tr> 
					...
					<td><input id = "IPEdit"
									...
									type = "text"
									value = ""/></td>
					<td><input id = "ServerPortEdit"
									name = "ServerPort"
									type = "text"
									value = ""/></td> 
					<td><input id = "LastConnectionEdit"
									name = "Lastconnection"
									type = "text"
									value = ""/></td>
									
					<td><input id = "nameOldEdit"
									name = "nameOld"
									type = "text"
									value = ""/></td> 
					<td><input id = "IPOldEdit"
									name = "IPOld"
									type = "text"
									value = ""/></td>
					<td><input id = "ServerPortOldEdit"
									name = "ServerPortOld"
									type = "text"
									value = ""/></td> 
					<td><input id = "LastConnectionOldEdit"
									name = "LastconnectionOld"
									type = "text"
									value = ""/></td>
...
<% for (Device device : deviceList){ %>
	<tr> 
		<td></td>
		<td id = "nameEdit"><%out.print(device.getName()); %></td>
		<td id = "IPEdit"><%out.print(device.getIP()); %></td>
		<td id = "serverPortEdit"><%out.print(device.getServerPort());%></td>
		<td id = "lastConnectionEdit"><%out.print(device.getLastConnection());%></td>
		
		<td><input id = "editButton"
				type="submit"
				value="edit"
